...
const getEyeDropperConstructor = (): EyeDropperConstructor | undefined => {
  ...
  return (globalThis as unknown as { EyeDropper?: EyeDropperConstructor }).EyeDropper;
};
 ...
 * @returns
 */
export const isEyedropperSupported = (): boolean => typeof getEyeDropperConstructor() === 'function';
