import { compareNumber, isInputNumber, formatENumber } from '../../../js/input-number/large-number';

describe('compareNumber', () => {
  it('0.1, 0.2', () => {
    expect(compareNumber('0.1', '0.2')).toBe(-1);
  });

  it('0.2, 0.1', () => {
    expect(compareNumber('0.2', '0.1')).toBe(1);
  });

  it('0.8, 0.80000', () => {
    expect(compareNumber('0.8', '0.80000')).toBe(0);
  });

  it('0.88888888, 0.111', () => {
    expect(compareNumber('0.88888888', '0.111')).toBe(1);
  });
  ...
  it('001, 1', () => {
    expect(compareNumber('001', '1')).toBe(0);
  });

  it('0.01, 1', () => {
    expect(compareNumber('0.01', '1')).toBe(-1);
  });

  it('00, 0', () => {
    expect(compareNumber('00', '0')).toBe(0);
  });
  ...
  it('2134, 888', () => {
    expect(compareNumber('2134', '888')).toBe(1);
  });

  it('2.134, 88.8', () => {
    expect(compareNumber('2.134', '88.8')).toBe(-1);
  });
  ...
  it('4241234, 41234534', () => {
    expect(compareNumber('4241234', '41234534')).toBe(-1);
  });
  ...
  it('string 1234567891234567890, string 1234567891234567891', () => {
    expect(compareNumber('1234567891234567890', '1234567891234567891', true)).toBe(-1);
  });
